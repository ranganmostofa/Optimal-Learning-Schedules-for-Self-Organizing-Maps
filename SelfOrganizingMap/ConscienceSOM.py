...
class ConscienceSOM:
    ...
    def train(self, input_map, learning_rate_schedule, neighborhood_radius_schedule, num_iter, beta=0.0001, C=10):
        """
...
som = ConscienceSOM(lattice_dimension, prototype_dimension)
